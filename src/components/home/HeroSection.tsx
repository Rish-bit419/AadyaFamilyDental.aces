...
import { Phone, Calendar, Shield, Award, Sparkles, CheckCircle } from "lucide-react";
  ...
  return (
    <section className="relative bg-gradient-to-br from-primary via-teal-dark to-primary overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-primary-foreground/5 rounded-full blur-2xl animate-pulse" />
      </div>
      ...
      <div className="container-custom relative z-10">
        <div className="min-h-[90vh] flex flex-col lg:flex-row items-center justify-between gap-12 py-20 px-4 md:px-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8 animate-slide-up">
            <div className="inline-flex items-center gap-2 bg-primary-foreground/15 backdrop-blur-sm rounded-full px-5 py-2.5 border border-primary-foreground/20">
          ...
          <div className="flex-1 relative animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="aspect-square rounded-[2.5rem] bg-gradient-to-br from-primary-foreground/20 to-primary-foreground/5 backdrop-blur-sm border border-primary-foreground/20 overflow-hidden shadow-2xl">
                <img 
                  src="/hero-dental.jpg" 
              ...
              {/* Floating Stats Card */}
              <div className="absolute -bottom-6 -left-6 glass-effect rounded-2xl p-5 shadow-xl border border-border/30 animate-slide-up" style={{ animationDelay: "0.5s" }}>
              ...
              {/* Floating Badge */}
              <div className="absolute -top-4 -right-4 glass-effect rounded-2xl p-4 shadow-xl border border-border/30 animate-slide-up" style={{ animationDelay: "0.6s" }}>
