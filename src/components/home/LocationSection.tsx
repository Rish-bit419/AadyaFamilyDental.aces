...
const LocationSection = () => {
  ...
  const getContactCards = (loc: Location) => [
    ...
    { icon: Phone, title: "Phone", content: loc.phone || "+91 98765 43210", action: `tel:${(loc.phone || "+919876543210").replace(/\s/g, "")}` },
      ...
      <div className="container-custom">
        <div className="text-center mb-10 animate-slide-up">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Modern clinics designed with your comfort in mind. Easy parking,
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                {getContactCards(current).map((card, index) => (
                  <div
                    key={card.title}
                    className="group flex items-start gap-4 p-4 bg-secondary rounded-2xl hover:bg-card hover:shadow-soft transition-all duration-300"
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href={`https://wa.me/91${(current.whatsapp || "9876543210").replace(/\D/g, "")}`}
                  target="_blank"
