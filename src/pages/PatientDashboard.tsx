 ...
 import { 
   Calendar, Clock, FileText, User, LogOut, Heart, Star, 
   Video, Calculator, Smile, MessageSquare, ArrowRight, CheckCircle
 } from "lucide-react";
           ...
           <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8 animate-slide-up">
             <div>
               <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground">
                 Welcome back, {user?.user_metadata?.full_name?.split(" ")[0] || "Patient"}!
               </h1>
