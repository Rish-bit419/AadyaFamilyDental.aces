  ...
  return (
    <div className="min-h-screen bg-secondary flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {/* Login Card */}
        <div className="bg-card rounded-2xl p-8 shadow-medium border border-border/50 animate-scale-in">
          {/* Logo */}
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Sign in to manage your dental clinic</p>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Admin access only. Contact IT for support.
          </p>
        </div>
      </div>
    </div>
